#ifndef __INET_IPV4ECMPROUTINGTABLE_H
#define __INET_IPV4ECMPROUTINGTABLE_H
 ...
 */
class INET_API IPv4ECMPRoutingTable : public cSimpleModule, public IIPv4RoutingTable, protected cListener, public ILifecycle
{
  protected:
  ...
  protected:
    ...
    class RouteLessThan
    {
        const IPv4ECMPRoutingTable &c;
      public:
        RouteLessThan(const IPv4ECMPRoutingTable& c) : c(c) {}
  ...
  public:
    IPv4ECMPRoutingTable() {}
    virtual ~IPv4ECMPRoutingTable();
  ...
  public:
     ...
     */
    virtual IPv4Route *findBestMatchingRoute(const IPv4Address&) const override { EV_ERROR << "Not implemented\n"; return nullptr; };

    virtual IPv4Route *findBestMatchingRoute(const IPv4Address& src, const IPv4Address& dest) const;
...
#endif // ifndef __INET_IPV4ECMPROUTINGTABLE_H
