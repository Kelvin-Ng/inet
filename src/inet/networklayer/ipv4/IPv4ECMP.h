...
class IPv4ECMPRoutingTable;

/**
 * Implements the IPv4ECMP protocol.
 */
class INET_API IPv4ECMP : public QueueBase, public INetfilter, public ILifecycle, public INetworkProtocol, public cListener
{
  public:
    /**
  ...
  protected:
    IPv4ECMPRoutingTable*rt = nullptr;
  ...
  protected:
    ...
    /**
     * Creates a blank IPv4ECMP datagram. Override when subclassing IPv4Datagram is needed
     */
    ...
    /**
     * Handle messages (typically packets to be send in IPv4ECMP) from transport or ICMP.
  ...
  protected:
    ...
    /**
     * Processing of IPv4ECMP datagrams. Called when a datagram reaches the front
     * of the queue.
     */
